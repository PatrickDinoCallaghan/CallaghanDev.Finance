...
namespace CallaghanDev.Finance.TechnicalAnalysis
{
    ...
    {
        public static Core.RetCode Hikkake(
          ...
          out Range outRange)
        {
            return Candles.Hikkake<float>(inOpen, inHigh, inLow, inClose, inRange, outIntType, out outRange);
        }
        public static CallaghanDev.Finance.TechnicalAnalysis.Core.RetCode Hikkake<T>(
            ...
            out Range outRange) where T : IFloatingPointIeee754<T>
        {
            ...
            {
                return CallaghanDev.Finance.TechnicalAnalysis.Core.RetCode.OutOfRangeParam;
            }
            ...
            if (startIdx > endIdx)
            {
                return CallaghanDev.Finance.TechnicalAnalysis.Core.RetCode.Success;
            }
